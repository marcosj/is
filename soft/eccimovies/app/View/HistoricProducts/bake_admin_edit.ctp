...
<?php echo $this->Form->create('HistoricProduct'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Historic Product'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('HistoricProduct.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('HistoricProduct.id')))); ?></li>
