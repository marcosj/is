<div class="productsWishlists index">
	...
	<tr>
		...
		<td><?php echo h($productsWishlist['ProductsWishlist']['wishlist_id']); ?>&nbsp;</td>
		<td><?php echo h($productsWishlist['ProductsWishlist']['user_id']); ?>&nbsp;</td>
		<td><?php echo h($productsWishlist['ProductsWishlist']['product_id']); ?>&nbsp;</td>
		<td class="actions">
