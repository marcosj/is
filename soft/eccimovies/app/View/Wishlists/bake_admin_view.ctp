...
<h2><?php echo __('Wishlist'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($wishlist['User']['username'], array('controller' => 'users', 'action' => 'view', $wishlist['User']['id'])); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Wishlist'), array('action' => 'delete', $wishlist['Wishlist']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $wishlist['Wishlist']['id']))); ?> </li>
