<div class="wishlists index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $wishlist['Wishlist']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $wishlist['Wishlist']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
