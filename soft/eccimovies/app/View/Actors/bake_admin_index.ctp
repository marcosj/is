<div class="actors index">
	...
	<tr>
		...
		<td><?php echo h($actor['Actor']['full_name']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $actor['Actor']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $actor['Actor']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
